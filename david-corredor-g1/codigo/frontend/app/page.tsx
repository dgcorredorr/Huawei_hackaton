    ...
    <main className="atlas-shell">
      <aside className="sidebar">
        ...
        <nav className="nav-list" aria-label="Navegación principal">
          <button className="nav-item active"><Inbox size={17} /> Cola de triage <span>12.847</span></button>
          <button className="nav-item" onClick={() => setActiveTab('incidents')}><AlertTriangle size={17} /> Incidentes <span className="nav-alert">2</span></button>
